...
setosa <- mean(splits$setosa$Sepal.Length) 
catXWithString(string = "Mean of setosa length: ")
versicolor <- mean(splits$versicolor$Sepal.Length)
catXWithString(versicolor,string = "Mean of versicolor length: ")
virinica <- mean(splits$virginica$Sepal.Length)
catXWithString(virinica, string = "Mean of virginica length: ")
