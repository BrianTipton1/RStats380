...
# iii) Based on what you see in parts (i) and (ii), do you suspect the `concentration` levels for indoor and outdoor are different? 
# Why?  
cat("yes there is a difference in the concentration levels. This is because ")

# iv) Is a paired sample analysis appropriate for this data? 
# Why?
cat("Yes I believe yes because ")

# v) Calculate a confidence interval for the population mean difference between indoor and outdoor concentrations using a confidence interval of 95\%,
...
cat("We can reject the null hypothesis. Range and p-value to make the decision.")
