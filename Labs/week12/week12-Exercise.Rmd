...
# i) Construct scatterpots for `sale price versus size` and `sale price versus land-to-building ratio`.
...
# iii) Use the `lm` function to estimated the equations of each fitted line for for `sale price versus size` and `sale price versus land-to-building ratio`.
